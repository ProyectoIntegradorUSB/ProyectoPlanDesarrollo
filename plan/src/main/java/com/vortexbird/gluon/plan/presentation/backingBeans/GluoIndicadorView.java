...
public class GluoIndicadorView implements Serializable {
	...
	public void listener_txtId() {
		try {
			...
			entity = (indiId != null) ? businessDelegatorView.getGluoIndicador(indiId) : null;
		} catch (Exception e) {
			entity = null;
		}
	...
	public String action_edit(ActionEvent evt) {
		selectedGluoIndicador = (GluoIndicadorDTO) (evt.getComponent().getAttributes().get("selectedGluoIndicador"));
	...
	public String action_create() {
		try {
			...
			FacesContext.getCurrentInstance().addMessage("", 
					new FacesMessage(FacesMessage.SEVERITY_INFO, "El Indicador de Proyecto se ha creado exitosamente", ""));
			action_clear();
		} catch (Exception e) {
			entity = null;
			FacesUtils.addErrorMessage(e.getMessage());
	...
	public String action_modify() {
		try {
			...
			FacesContext.getCurrentInstance().addMessage("", 
					new FacesMessage(FacesMessage.SEVERITY_WARN, "El Indicador de Proyecto ha sido modificado", ""));
		} catch (Exception e) {
			data = null;
			FacesUtils.addErrorMessage(e.getMessage());
		}
	...
	public String action_delete_datatable(ActionEvent evt) {
		try {
			selectedGluoIndicador = (GluoIndicadorDTO) (evt.getComponent().getAttributes()
	...
	public String action_modifyWitDTO(String activo, String descripcionIndicador, String descripcionLineaBase,
			String descripcionMeta, Date fechaCreacion, Date fechaModificacion, Integer indiId, Integer usuCreador,
			Integer usuModificador, Double valorMeta, Integer proyId_GluoProyecto) throws Exception {
		try {
			entity.setActivo(FacesUtils.checkString(activo));
			entity.setDescripcionIndicador(FacesUtils.checkString(descripcionIndicador));
			entity.setDescripcionLineaBase(FacesUtils.checkString(descripcionLineaBase));
