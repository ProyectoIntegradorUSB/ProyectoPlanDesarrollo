    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
	...
	public SegUsuario validarUsuario(String usuLogin, String usuClave) throws Exception {
		...
		if (usuLogin != null && usuLogin.trim().equals("")) {
			throw new Exception("No me haga perder el tiempo ingrese el login.");
		}
		
		if (usuClave != null && usuClave.trim().equals("")) {
			throw new Exception("No me haga perder el tiempo ingrese el login.");
		}
		
		SegUsuario segUsuario = segUsuarioDAO.consultarUsuarioPorLogin(usuLogin);
		
		if(segUsuario==null){
			throw new Exception("El usuario o password no son validos");
		}
		if(segUsuario.getUsuPassword().equals(usuClave)==false){
			throw new Exception("El usuario o password no son validos");
		}
