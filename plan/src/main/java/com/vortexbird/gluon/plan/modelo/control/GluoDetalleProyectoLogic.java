...
public class GluoDetalleProyectoLogic implements IGluoDetalleProyectoLogic {
    ...
    */
    ...
    public List <GluoDetalleProyecto> findDetalleProyectoActivo()throws Exception{
    	...
    	List<GluoDetalleProyecto> listaActivos= new ArrayList<GluoDetalleProyecto>();
    	
    	try {
    		listaActivos=gluoDetalleProyectoDAO.find("FROM GluoDetalleProyecto dp WHERE dp.activo='A'");
    	}catch(Exception e) {
