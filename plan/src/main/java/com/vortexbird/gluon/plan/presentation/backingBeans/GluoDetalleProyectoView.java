...
//                        txtProyId_GluoProyecto)) : null);
            ...
            FacesContext.getCurrentInstance().addMessage("",
					new FacesMessage(FacesMessage.SEVERITY_INFO, "El detalle del proyecto se almacenó con exito", ""));
            action_clear();
        } catch (Exception e) {
            entity = null;
            FacesUtils.addErrorMessage(e.getMessage());
    ...
    public String action_modify() {
        try {
          ...
          //  entity.setUsuCreador(FacesUtils.checkInteger(txtUsuCreador));
            SegUsuario segUsuario = (SegUsuario) FacesUtils.getfromSession("usuarioEnSession");
			Integer usuModificador = Integer.valueOf(segUsuario.getUsuId());
			entity.setUsuModificador(usuModificador);
...
//                        txtProyId_GluoProyecto)) : null);
            ...
            FacesContext.getCurrentInstance().addMessage("",
					new FacesMessage(FacesMessage.SEVERITY_INFO, "El detalle de proyecto se modificó con exito", ""));
        } catch (Exception e) {
            data = null;
            FacesUtils.addErrorMessage(e.getMessage());
        }
	...
	public void setAnoFiscalItems(List<SelectItem> AnoFiscalItems ) {
		this.AnoFiscalItems=AnoFiscalItems;
	}
